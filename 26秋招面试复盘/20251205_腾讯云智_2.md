...
**你说到了Redis的string，可以说说Redis里面的string和cpp中的string实现有什么区别吗？**
...
**顺便说说`List, Hash, Set, Zset`在Redis中具体是怎么实现的？**
...
**拓展：既然说到了Redis对象的数据类型，那么Redis的KV组织是基于什么数据结构的？**
...
G了，这里直接说不会，面试官笑着反问，那你简历上还说自己对数据结构比较熟悉🤣🤣🤣，没办法，好像也不能狡辩。
...
如何在日常开发中深入理解像RAG，MCP，AI Agent这样的概念？



腾讯云智和CSIG事业群在业务分配上，有什么区别吗？

这里面试官挺好的，说到了腾讯云智其实就是CSIG事业群的子公司，做的业务也没有区别，只是
